const listType = 'TEST_POINT_'
export const SET_RESFRESH = listType + 'SET_RESFRESH'
export const SET_DISPLAYED_READING = listType + 'SET_DISPLAYED_READING'
export const SET_SORTING_SETTING = listType + 'SET_SORTING_SETTING'
export const SET_FILTER_VIEW = listType + 'SET_FILTER_VIEW'
export const APPLY_FILTER = listType + 'APPLY_FILTER'
export const RESET_FILTERS = listType + 'RESET_FILTERS'
...
export const ON_FILTER_BUTTON_PRESS = listType + 'ON_FILTER_BUTTON_PRESS'
